...
class BuildConfig(BaseModel):
    ...
    pushSecretName: str = ""      # Secret with raw token under key 'api' (e.g. from ExternalSecrets)
    pullSecretName: str = ""      # docker-registry secret for pulling built images (leave empty if public)
